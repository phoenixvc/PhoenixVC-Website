...
This document outlines more advanced or alternative Docker configurations for our project, beyond the local development setup described in [development-setup.md](/src/main/guides/infrastructure/development/development-setup.md).
...
- **Production/Staging:**  
  - May use a separate `docker-compose.prod.yml` or a specialized infrastructure IaC (see [bicep-templates.md](/src/main/guides/infrastructure/bicep-templates.md)).
...
- [Development Setup](/src/main/guides/infrastructure/development/development-setup.md)
- [Infrastructure Docs](/src/main/guides/infrastructure/readme.md)
- [Bicep Templates](/src/main/guides/infrastructure/bicep-templates.md)
- [Azure Deployment Guide](/src/main/guides/infrastructure/deployment/deployment.md)
