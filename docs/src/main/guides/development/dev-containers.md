...
# Dev Containers Setup {: #dev-containers-setup}
...
## Customizing the Dev Container {: #customizing-the-dev-container}
...
### Example `devcontainer.json`: {: #example-devcontainerjson}
```json
{
