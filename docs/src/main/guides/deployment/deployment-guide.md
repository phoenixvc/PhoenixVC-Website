...
1. **Review Prerequisites**  
   ...
   Refer to [prerequisites.md](/src/main/guides/deployment/prerequisites.md) for system requirements and the validation script.
...
5. **Post-Deployment Verification**  
   ...
   - Run health checks (see [operations.md](/src/main/guides/deployment/operations.md) for details):
     ```bash
...
If any step fails, refer to [troubleshooting.md](/src/main/guides/deployment/troubleshooting.md) for guidance on common issues and rollback procedures.

## Additional References {: #additional-references}
- Detailed environment configuration can be found in [configuration.md](/src/main/guides/deployment/configuration.md).
- For routine operational tasks, see [operations.md](/src/main/guides/deployment/operations.md).
