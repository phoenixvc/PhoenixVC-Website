# Operational Procedures Guide {: #operational-procedures-guide}
...
### 4. Access Review {: #4-access-review}
...
### 1. Planned Maintenance {: #1-planned-maintenance}
...
# Execute update commands or swap deployment slots as needed, e.g.: {: #execute-update-commands-or-swap-deployment-slots-as-needed-eg}
...
### 1. Alert Configuration {: #1-alert-configuration}
