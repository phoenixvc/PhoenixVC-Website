# Azure Component Versions Reference {: #azure-component-versions-reference}
**Last Updated:** 2025-02-14

## Production Environment Components {: #production-environment-components}
...
## API Versions Reference {: #api-versions-reference}
