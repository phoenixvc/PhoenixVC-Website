...
const INTENT_PLACEHOLDERS: Record<ContactIntent, string> = {
  ...
  investment:
    "Tell us about your company, stage, funding needs, and what makes your solution unique...",
  partnership:
    "Describe your company and the partnership opportunity you'd like to explore...",
  media:
    "Share details about your media inquiry, publication, or interview request...",
...
const ContactForm: FC<ContactFormProps> = memo(
  ({ onSubmit, isLoading, isSuccess }): React.ReactElement => {
    ...
    const handleSubmit = (e: React.FormEvent): void => {
      ...
      if (honeypot) {
        logger.warn(
          "[ContactForm] Honeypot triggered - likely spam submission",
        );
