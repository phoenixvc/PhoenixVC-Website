  // features/contact/components/ContactForm/index.tsx
        ...
        <form className={contactFormStyles.form} onSubmit={handleSubmit(onSubmit)}>
          <div className={contactFormStyles.inputGrid}>
            <div>
              ...
              />
              {errors.name && (
                <span className={contactFormStyles.error}>{errors.name.message}</span>
              )}
            </div>
            <div>
              <input
              ...
              />
              {errors.email && (
                <span className={contactFormStyles.error}>{errors.email.message}</span>
              )}
            </div>
          </div>
          ...
          <div>
            ...
            />
            {errors.subject && (
              <span className={contactFormStyles.error}>{errors.subject.message}</span>
            )}
          </div>
          ...
          <div>
            ...
            />
            {errors.message && (
              <span className={contactFormStyles.error}>{errors.message.message}</span>
            )}
          </div>
