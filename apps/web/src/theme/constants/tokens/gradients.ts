...
export function createLinearGradient(
  ...
  const dir =
    gradientDirections[direction as keyof typeof gradientDirections] ||
    direction;
...
export const gradients = {
  // Light gradients
  lightFade: createLinearGradient("toBottom", [
    "rgba(255,255,255,0)",
    "rgba(255,255,255,1)",
  ]),
  lightGlow: createRadialGradient("circle", "center", [
    "rgba(255,255,255,0.8)",
    "rgba(255,255,255,0)",
  ]),

  // Dark gradients
  darkFade: createLinearGradient("toBottom", [
    "rgba(0,0,0,0)",
    "rgba(0,0,0,1)",
  ]),
  darkGlow: createRadialGradient("circle", "center", [
    "rgba(0,0,0,0.8)",
    "rgba(0,0,0,0)",
  ]),
  ...
  // Radial gradients
  lightRadial: createRadialGradient("circle", "center", [
    "white",
    "rgba(255,255,255,0)",
  ]),
  darkRadial: createRadialGradient("circle", "center", [
    "black",
    "rgba(0,0,0,0)",
  ]),

  // Conic gradients
  rainbow: createConicGradient("center", "0deg", [
    "red",
    "orange",
    "yellow",
    "green",
