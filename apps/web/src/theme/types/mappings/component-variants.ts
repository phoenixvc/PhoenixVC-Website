 ...
 */
export const isInteractiveVariant = (
  variant: ComponentVariantType,
): variant is InteractiveVariant & ComponentVariantType => {
  return "interactive" in variant && variant.interactive !== undefined;
};

export const isNavigationVariant = (
  variant: ComponentVariantType,
): variant is NavigationVariant => {
  return (
    "item" in variant &&
    variant.item !== undefined &&
    "default" in variant.item &&
    variant.item.active !== undefined
  );
};

export const isTabVariant = (
  variant: ComponentVariantType,
): variant is TabVariant => {
  return "selected" in variant && variant.selected !== undefined;
};

export const isInputVariant = (
  variant: ComponentVariantType,
): variant is InputVariant => {
  return "readonly" in variant && "error" in variant && "success" in variant;
};

export const isSidebarVariant = (
  variant: ComponentVariantType,
): variant is SidebarVariant => {
  return (
    "container" in variant &&
    "group" in variant &&
    "item" in variant &&
