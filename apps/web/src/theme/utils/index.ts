...
import { COLOR_SCHEMES, DEFAULT_COLOR_SCHEME, DEFAULT_MODE, STORAGE_KEYS } from '../constants';
...
export const getThemeColors = (scheme: ColorScheme, mode: Mode): ThemeColors => {
  // We no longer override colors for dark mode in JS;
  // the dark variants are defined in CSS.
...
export const setTheme = (colorScheme: ColorScheme, mode: Mode): void => {
  ...
  // Dynamically remove any previous theme classes that start with "theme-"
